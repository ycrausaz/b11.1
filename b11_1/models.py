...
class Material(models.Model):
    ...
    vertriebsweg = models.ForeignKey(Vertriebsweg, null=True, on_delete=models.DO_NOTHING, verbose_name="Vertriebsweg ")
    allgemeine_positionstypengruppe = models.ForeignKey(AllgemeinePositionstypengruppe, null=True, on_delete=models.DO_NOTHING, verbose_name="Allgemeine Positionstypengruppe ")
    fuehrendes_material = models.CharField(null=True, blank=True)
    auszeichnungsfeld = models.ForeignKey(Auszeichnungsfeld, null=True, on_delete=models.DO_NOTHING, verbose_name="Auszeichungsfeld ")
    cpv_code = models.CharField(null=True, blank=True)
    fertigungssteuerer = models.ForeignKey(Fertigungssteuerer, null=True, on_delete=models.DO_NOTHING, verbose_name="Fertigungssteuerer ")
    cpv_code = models.CharField(null=True, blank=True)
    kennzeichen_komplexes_system = models.CharField(null=True, blank=True)
    sonderablauf = models.ForeignKey(Sonderablauf, null=True, on_delete=models.DO_NOTHING, verbose_name="Sonderablauf ")
    cpv_code = models.CharField(null=True, blank=True)
    temperaturbedingung = models.ForeignKey(Temperaturbedingung, null=True, on_delete=models.DO_NOTHING, verbose_name="Temperaturbedingung ")
    bewertungsklasse = models.ForeignKey(Bewertungsklasse, null=True, on_delete=models.DO_NOTHING, verbose_name="Bewertungsklasse ")
    ...
    zuteilung = models.ForeignKey(Zuteilung, null=True, on_delete=models.DO_NOTHING, verbose_name="Zuteilung ")
    auspraegung = models.ForeignKey(Auspraegung, null=True, on_delete=models.DO_NOTHING, verbose_name="Ausprägung ")
