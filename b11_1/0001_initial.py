# Generated by Django 5.0.3 on 2024-06-25 09:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verteilung_svsaa', models.BooleanField(blank=True, null=True)),
                ('verteilung_cheops', models.BooleanField(blank=True, null=True)),
                ('allgemeine_positionstypengruppe', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.allgemeinepositionstypengruppe', verbose_name='Allgemeine Positionstypengruppe ')),
                ('auspraegung', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.auspraegung', verbose_name='Ausprägung ')),
                ('auszeichnungsfeld', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.auszeichnungsfeld', verbose_name='Auszeichungsfeld ')),
                ('basismengeneinheit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.basismengeneinheit', verbose_name='Basismengeneinheit ')),
                ('begru', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.begru', verbose_name='BEGRU ')),
                ('bewertungsklasse', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.bewertungsklasse', verbose_name='Bewertungsklasse ')),
                ('fertigungssteuerer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.fertigungssteuerer', verbose_name='Fertigungssteuerer ')),
                ('gefahrgutkennzeichen', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.gefahrgutkennzeichen', verbose_name='Gefahrgutkennzeichen ')),
                ('materialart_grunddaten', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.materialart', verbose_name='Materialart ')),
                ('materialzustandsverwaltung', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.materialzustandsverwaltung', verbose_name='Materialzustandsverwaltung ')),
                ('rueckfuehrungscode', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.rueckfuehrungscode', verbose_name='Rückführungscode ')),
                ('serialnummerprofil', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.serialnummerprofil', verbose_name='Serialnummerprofil ')),
                ('sonderablauf', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.sonderablauf', verbose_name='Sonderablauf ')),
                ('spare_part_class_code', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.sparepartclasscode', verbose_name='Spare Part Class Code ')),
                ('sparte', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.sparte', verbose_name='Sparte ')),
                ('temperaturbedingung', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.temperaturbedingung', verbose_name='Temperaturbedingung ')),
                ('uebersetzungsstatus', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.uebersetzungsstatus', verbose_name='Übersetzungsstatus ')),
                ('vertriebsweg', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.vertriebsweg', verbose_name='Vertriebsweg ')),
                ('werk_1', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.werk_1', verbose_name='Werk (1) ')),
                ('werk_2', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.werk_2', verbose_name='Werk (2) ')),
                ('werk_3', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.werk_3', verbose_name='Werk (3) ')),
                ('werk_4', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.werk_4', verbose_name='Werk (4) ')),
                ('zuteilung', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='b11_1.zuteilung', verbose_name='Zuteilung ')),
            ],
        ),
    ]
